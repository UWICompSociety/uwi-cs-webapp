...
from models import About, Person, ImageView, ProjectView, Project, CarouselView, Carousel, NewsView, News, ExecutivesView, Executives, MyModelView, Images, Developers
...
admin.add_view(MyModelView(Developers, db.session))
